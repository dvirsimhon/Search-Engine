...
public class ReadFile {
    ...
    public void printCorpusDocuments() {
        System.out.println(l_corpusDocuments.size());
        for (int i = 0; i < 2; i++) {
            System.out.println(l_corpusDocuments.get(i).getDocNO());
            System.out.println(l_corpusDocuments.get(i).getText());
            System.out.println(l_corpusDocuments.get(i).getDate());
            System.out.println(l_corpusDocuments.get(i).getTitle());
        }
    }
